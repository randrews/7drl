...
function MapGenerator:generate()
    local maze = self:create_maze(10, 10)
    self:create_rooms(maze) -- Turn 1/3 of the cells into rooms
    -- local map = self:expand(maze) -- Make a map that follows the layout of the maze
    -- self:add_walls(map) -- Add walls and doors
    -- self:place_monsters(map) -- Monsters!
    -- self:place_chests(map) -- Chests and treasure piles
